...
function CompStructSize({
  structureImg = defaultStructure,
  planetType,
  structure,
  composition,
  surface,
    ...
    <div className="comp">
      ...
      <div className="text-w-image comp">
        <div className="structure">
          <img
            src={structureImg}
            alt={"Graphic of planet's internal structure"}
            style={{ marginBottom: "40px" }}
          />
          {planetType == "Terrestrial" ? (
            <div className="glass-box" style={{ maxWidth: "80%" }}>
              <p>
                <strong style={{ color: lightColor }}>Metal core:</strong>{" "}
                Highest density
              </p>
              <p>
                <strong style={{ color: mediumColor }}>Mantle:</strong> Medium
                density
              </p>
              <p>
                <strong style={{ color: mainColor }}>Rocky Crust:</strong> Lower
                density
              </p>
              <p>
                <strong style={{ color: darkColor }}>Rigid Lithosphere:</strong>{" "}
            ...
            <div className="glass-box" style={{ maxWidth: "80%" }}>
              <p>
                <strong style={{ color: lightColor }}>
                  Core of Rock, Metals, and Hydrogen Compounds
                </strong>
              </p>
              <p>
                <strong style={{ color: mainColor }}>Metallic Hydrogen</strong>
              </p>
              <p>
                <strong style={{ color: mediumColor }}>Liquid Hydrogen</strong>
              </p>
              <p>
                <strong style={{ color: mediumColor2 }}>
                  Gaseous Hydrogen
                </strong>
              </p>
              <p>
                <strong style={{ color: darkColor }}>Visible Clouds</strong>
              </p>
            </div>
          ) : (
            <div className="glass-box" style={{ maxWidth: "80%" }}>
              ...
              <p>
                <strong style={{ color: mediumColor }}>Gaseous Hydrogen</strong>
              </p>
              <p>
                <strong style={{ color: darkColor }}>Visible Clouds</strong>
              </p>
