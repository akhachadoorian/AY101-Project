  ...
  return (
    <div className="mars">
      ...
      <GeologicalActivity
        ...
        summaryText={
          "In summary, the planet previously had volcanoes, plate tectonics, and a magnetic field. The cooling of the internals of the planet resulted in the lose of these items."
        }
        color={planetColor}
      />
