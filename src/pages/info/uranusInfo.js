export const stats = {
    ...
    distanceFromSun: {
        ...
        stat: [
            "19.18 astronomical units",
        ],
    },
    mass: {
        title: "Mass",
        stat: [
            "866 x 10<sup>23</sup> kg",
        ],
    },
    density: {
        title: "Density",
...
export const surface = {
    p: "Uranus’ atmosphere proceeds to get denser and denser as you move towards the center of the planet due to an increase in pressure, resulting in the planet not having a physical surface."
}
