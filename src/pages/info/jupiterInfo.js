...
export const geological = {
    ...
    magnet: {
        ...
        icon: 'magnet',
        paragraphs: "Jupiter has a strong magnetic field due to the electric current generated by the metallic hydrogen layer [1]. Jupiter's magnetic field results in a magnetosphere similar to Earth's. Jupiter's magnetic field results in a magnetosphere significantly larger than Earth's; thus, Jupiter's magnetosphere can block solar winds further away from the planet than Earth's magnetosphere can [1]."
    },
}
...
export const size = {
    p: "Jupiter is the largest planet in the solar system. If you summed the masses of the other planets in the solar system, Jupiter's mass would still exceed theirs [Textbook]. "
}
...
export const moons = {
    io: {
        ...
        geo: "Areas that appear black, brown, green, orange, and red denote active volcanic areas [2]. Even though IO is smaller than Earth, its interior is molten, and as a result, the moon has plate tectonics alongside its volcanic activity. The plate tectonics renew the moon’s surface, resulting in a crater-free smooth surface. The reason IO’s interior is molten is due to tidal heating.",
    },
    europa: {
        name: 'Europa',
        p: "Europa, another one of Jupiter’s moons, is composed of ice, rock, and metal and surrounded by a 100-kilometer-thick H2O layer. This moon is smaller than IO. On the moon’s surface is ice and more shockingly, the planet’s interior is a liquid ocean. This interior ocean is a result of the tidal heating the moon faces.",
